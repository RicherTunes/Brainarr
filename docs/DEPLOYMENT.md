...
> Compatibility
> Requires Lidarr 3.1.2.4913+ on the plugins/nightly branch. The hotio plugins image `ghcr.io/hotio/lidarr:pr-plugins-3.1.2.4913` or later provides the required .NET 8 host.
