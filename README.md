...
[![Latest Release](https://img.shields.io/badge/latest_release-1.2.4-brightgreen)](https://github.com/RicherTunes/Brainarr/releases/tag/v1.2.4)
...
>
> Provider Status
> Latest release: **v1.2.4** (tagged). Main branch version: **v1.2.4** with nightly patches in progress.
>
> | Provider | Type | Status |
> | --- | --- | --- |
> | LM Studio | Local | ✅ Verified in v1.2.4 |
> | Gemini | Cloud | ✅ Verified in v1.2.4 |
> | Perplexity | Cloud | ✅ Verified in v1.2.4 |
> | Ollama | Local | 🔄 Pending re-verification for the 1.2.5 cycle |
> | OpenAI, Anthropic, DeepSeek, Groq, OpenRouter | Cloud | ⚠️ Experimental — enable with caution until verified in a post-1.2.4 patch |
>
...
**Latest Release**: 1.2.4 (`v1.2.4` tag)

**Main Branch Version**: 1.2.4 (matches latest release; PRs now target 1.2.5 planning)
