...
namespace NzbDrone.Core.ImportLists.Brainarr.Services.Providers
{
    ...
    /// </summary>
    [Obsolete("Unused. All providers implement IAIProvider directly. OpenAICompatibleProvider extends this but has no concrete subclasses. Cast-checks for LastRateLimitInfo in AIService/RecommendationGenerator/ProviderLifecycleService are dead code. Consequence: IProviderHealthMonitor.RecordRateLimitInfo is permanently orphaned — rate-limit-based health degradation is unreachable. Consider removing.")]
