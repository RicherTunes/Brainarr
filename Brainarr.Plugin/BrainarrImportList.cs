...
namespace NzbDrone.Core.ImportLists.Brainarr
{
    ...
    /// This class serves as the thin integration layer between Lidarr and the Brainarr plugin,
    /// delegating all complex logic to specialized orchestrator services following SRP.
    /// </summary>
