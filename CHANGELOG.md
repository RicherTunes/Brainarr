...
- `ext/Lidarr.Plugin.Common` submodule bumped to v1.16.0 (commit `936556e`) to consume the new `SlidingWindowAuthFailureHandler`. `plugin.json` + `manifest.json` `commonVersion` fields updated to match.
